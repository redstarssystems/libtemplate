...
[source, bash]
----
$ clojure -Sdeps '{:deps {org.rssys/libtemplate {:git/sha "da808b2dc7c120ac720ef217e99f0cc97b3a7753" :git/url "https://github.com/redstarssystems/libtemplate.git"}}}' -Tnew create :template org.rssys/libtemplate :name com.example/lib01
