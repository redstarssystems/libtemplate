...
[source, bash]
----
clojure -Sdeps '{:deps {org.rssys/libtemplate {:git/tag "0.1.3" :git/sha "362998b" :git/url "https://github.com/redstarssystems/libtemplate.git"}}}' -Tnew create :template org.rssys/libtemplate :name com.example/lib01
