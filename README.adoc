...
[source, bash]
----
$ clojure -Sdeps '{:deps {org.rssys/libtemplate {:git/sha "e25a1366c92bd4d41b49dde2ac5399b15584cdb8" :git/url "https://github.com/redstarssystems/libtemplate.git"}}}' -Tnew create :template org.rssys/libtemplate :name com.example/lib01
