...
[source, bash]
----
$ clojure -Sdeps '{:deps {org.rssys/libtemplate {:git/sha "55c7b01ffb0f99a30f1a6c6570b9480d60d563c3" :git/url "https://github.com/redstarssystems/libtemplate.git"}}}' -Tnew create :template org.rssys/libtemplate :name com.example/lib01
